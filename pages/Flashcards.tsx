  ...
  if (activeDeck.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center h-[60vh] text-center">
        ...
        <p className="text-slate-500 mb-6 max-w-md">Enter a topic to generate your first deck using AI.</p>
  ...
  return (
    <div className="max-w-xl mx-auto py-10">
        <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-bold text-slate-800">Reviewing {activeDeck.length} cards</h2>
            <button 
        ...
        >
            <div className={`relative w-full h-full duration-500 transform transition-transform preserve-3d ${isFlipped ? 'rotate-y-180' : ''}`}>
                ...
                <div className="absolute w-full h-full backface-hidden bg-white border border-slate-200 rounded-2xl shadow-sm flex flex-col items-center justify-center p-8 text-center">
                    ...
                    <p className="mt-4 text-sm text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity">Click to flip</p>
                </div>
                ...
                <div className="absolute w-full h-full backface-hidden bg-slate-800 text-white rotate-y-180 rounded-2xl shadow-sm flex flex-col items-center justify-center p-8 text-center">
                    <div className="absolute top-4 right-4" onClick={(e) => e.stopPropagation()}>
                        <TTSPlayer text={currentCard.back} simple={true} className="text-white hover:text-white" />
                    </div>
        ...
        <div className="flex justify-center space-x-6 mt-8">
            <button 
                onClick={(e) => { e.stopPropagation(); handleNext(0, currentCard.topic); }}
            ...
            <button 
                onClick={(e) => { e.stopPropagation(); handleNext(100, currentCard.topic); }}
        ...
        <div className="mt-10 pt-6 border-t border-slate-200">
             <h4 className="text-sm font-bold text-slate-500 mb-2">Add more cards</h4>
