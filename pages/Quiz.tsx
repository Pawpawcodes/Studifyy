    ...
    return (
      <div className="flex flex-col items-center justify-center h-96">
        ...
        <h3 className="text-xl font-bold text-slate-700">
          Generating customized quiz...
        </h3>
        <p className="text-slate-500">
          Checking your weak areas and generating questions.
        </p>
      </div>
    );
  }
      ...
      <div className="max-w-3xl mx-auto py-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-8">
          <div className="flex justify-between items-start mb-6">
            <h3 className="text-xl font-medium text-slate-800 flex-1">
              {question.question}
            </h3>
          ...
          <div className="space-y-3">
            {question.options.map((opt, idx) => {
              ...
              if (isAnswered) {
                ...
                btnClass +=
                  "bg-white border-slate-200 hover:bg-slate-50 hover:border-primary";
              }
  ...
  return (
    <div className="max-w-2xl mx-auto py-10">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 text-center">
        ...
        <p className="text-slate-500 mb-8">
          Test your knowledge. We'll adapt the difficulty based on your
          performance.
        </p>
